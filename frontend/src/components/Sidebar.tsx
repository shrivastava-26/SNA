...
const navItems = [
  ...
  { label: 'Studies', path: '/studies', icon: <ScienceIcon fontSize="small" /> },
  { label: 'Sites', path: '/sites', icon: <LocationOnIcon fontSize="small" /> },
  { label: 'Examiners', path: '/examiners', icon: <PersonSearchIcon fontSize="small" /> },
];
...
export function Sidebar() {
  ...
  // Active check — also highlight sidebar item when on a detail sub-page
    ...
    <Drawer
      ...
      sx={{
        ...
        '& .MuiDrawer-paper': {
          ...
          bgcolor: '#0f766e',   // same as AppHeader primary.main
          color: '#e0f2f1',
          overflowX: 'hidden',
            ...
            <Tooltip key={item.path} title={open ? '' : item.label} placement="right">
              <ListItemButton
                ...
                sx={{
                  ...
                  '&:hover': {
                    bgcolor: active ? 'rgba(255,255,255,0.22)' : 'rgba(255,255,255,0.1)',
                  },
                }}
              >
                <ListItemIcon
